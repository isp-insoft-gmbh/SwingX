...
public class JXSearchFieldTest
{
  ...
  {
    final JXSearchField sf = new JXSearchField();
  ...
  public void testSearchButtonIcons() throws Exception
  {
    ...
    final TestIcon diff = new TestIcon( "different" );
  ...
  {
    final Border newBorder = BorderFactory.createEmptyBorder();
  ...
  {
    final SearchFieldUI ui = (SearchFieldUI) searchField.getUI();
  ...
  class TestIcon implements Icon
  {
    ...
    public TestIcon( final String name )
    {
      this.name = name;
    }
  ...
  {
    public TestIconUI( final String name )
    {
      super( name );
    }
  }
