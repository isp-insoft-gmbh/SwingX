/*
 * $Id: PercentConverter.java 4097 2011-11-30 19:22:13Z kschaefe $
 *
...
public class PercentConverter extends Converter<Integer, Float> {
    /**
     * {@inheritDoc}
     */
    @Override
    public Float convertForward(Integer value) {
        return value.floatValue() / 100f;
    }
    ...
    public Integer convertReverse(Float value) {
        return (int) (value.floatValue() * 100);
    }
}
